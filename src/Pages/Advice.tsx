const AdvicePage: React.FC = () => {
    return (
        <div className="relative min-h-full pl-[200px] bg-[url('/svg/bg_advice.svg')] bg-[center_-100px] -top-[200px] left-0 h-[1600px] w-[1920px] bg-cover bg-no-repeat z-20">
            <div className="pt-[400px] flex flex-row bg-cover z-0  pb-[550px]">
                ...
                <div className="relative w-[956px] h-[600px] rounded-3xl bg-pink-gray flex items-center justify-start">
                    ...
                    <div className="flex flex-col pl-[30px] pr-[34px]">
                        <input type="text" name="name" id="" placeholder="Full Name" className="h-[39px] w-[300px] pl-3 border border-blue-300 rounded-xl focus:outline-none focus:border-separate" />
                        <input type="email" name="name" id="" placeholder="Email" className="h-[39px] w-[300px] pl-3 mt-5 border border-blue-300 rounded-xl focus:outline-none focus:border-separate" />
                    </div>
